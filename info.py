...
# Bot information
SESSION = environ.get('SESSION', 'MovieFireBot')
...
SPELL_IMG = environ.get("SPELL_IMG", "https://graph.org/file/f8ba533ee81154c51e335.jpg")
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002178739335') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002088291862')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002074107811')
...
mongodb+srv://firemovies:skesavan7@cluster0.2gm7ulq.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "MovieFireBot2")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'FireMovieFiles')
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://graph.org/file/a4df4e310c3edd572446e.mp4')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/MovieFireTamil')
