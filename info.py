...
auth_channel = environ.get('AUTH_CHANNEL', '-1002157150880') # give your force subscribe channel id here else leave it blank
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'MovieFireFiles')
